 ...
 */
   ...
   typedef void (*PFN_GET_SYMBOL_CALLBACK)(unsigned long, char*);
#ifdef SUPPORT_64BIT_OFFSET
   ...
   void linuxice_format64(const _CodeInfo* ci, const _DInst* di, _DecodedInst* result, PFN_GET_SYMBOL_CALLBACK get_symbol_callback);
	#define linuxice_format linuxice_format64
   ...
   void linuxice_format32(const _CodeInfo* ci, const _DInst* di, _DecodedInst* result, PFN_GET_SYMBOL_CALLBACK get_symbol_callback);
	#define linuxice_format linuxice_format32
